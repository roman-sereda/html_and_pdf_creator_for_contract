...
def content
  ...
  bold('1. Предмет договору.')

  regular('1.1. Продавець зобов\'язується передати у власність (повне господарське відання), а Покупець належним чином прийняти і оплатити наступний товар:
  ...
  bold('2. Умови поставки й розрахунків за товар')

  regular('2.1. Строк поставки _______________________ днів з моменту ______________________ (укладання Договору, оплати й ін. умови) Продавець _______________ (має, не має) право на дострокову поставку.
  ...
  bold('3. Гарантії виконання зобов\'язань і відповідальність сторін')

  regular('3.1. Під час підписання Договору сторони обмінюються гарантіями поставки і оплати праці.
  ...
  regular('4.1. Сторони не несуть відповідальності, передбаченої в п. 3.2-3.7 Договору, якщо неможливість виконання ними умов Договору наступила в силу форс-мажорних обставин, у т.ч.  ___________________.
  ...
  bold'(5. Заключні умови)'

  regular('5.1. Договір може бути змінений, розірваний, визнаний недійсним тільки на підставі чинного законодавства.
  ...
  bold('6. Юридичні адреси й підписи сторін')

  regular('  6.1. У випадку зміни юридичної адреси або обслуговуючого банку, сторони зобов\'язані в ________-денний строк повідомити про це один одного.

  6.2. Реквізити сторін.

  6.2.1. Продавець #{$data[:seller_name]}.

  6.2.2. Покупець #{$data[:buyer_name]}.
